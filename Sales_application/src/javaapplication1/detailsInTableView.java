...
public class detailsInTableView extends JFrame implements ActionListener {
   ...
   public detailsInTableView(Object[] colNames,int Rcount,int Ccount,Object tblData[][]){
       this.Ccount=Ccount;
       this.Rcount=Rcount;
